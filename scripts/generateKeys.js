 ...
 * Ejecutar: node scripts/generateKeys.js [nombre_servicio]
 */
...
function generateSingleApiKey() {
  ...
  if (args.length === 0) {
    ...
    console.log('Uso: node scripts/generateKeys.js <nombre_servicio>\n');
    console.log('Ejemplo: node scripts/generateKeys.js kyc_service\n');
    return;
  }
