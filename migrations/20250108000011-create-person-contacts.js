// migrations/20250108000011-create-person-contacts.js
'use strict';
...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.createTable({ tableName: 'person_contacts', schema: SCHEMA }, {
      ...
      // PRIMARY PHONE (obligatorio verificar)
      phone_primary: {
      ...
      // SECONDARY PHONE (opcional, whatsapp, etc)
      phone_secondary: {
        type: Sequelize.STRING(20),
        allowNull: true
      },
    ...
    // Índice compuesto para verificación de email
