// packages/admin-gateway/src/server.js

/**
 * Admin Gateway - API Gateway for Admin Panel
 * 
 * Responsabilidades:
 * 1. Proxy requests a microservicios
 * 2. Autenticación y autorización de admins
 * 3. Rate limiting
...
app.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: 'Welcome to Admin Gateway',
    version: '1.0.0',
    service: 'admin-gateway',
    correlationId: req.correlationId,
  });
...
const server = app.listen(PORT, HOST, () => {
  logger.info('=================================================');
  logger.info('🎉 ADMIN GATEWAY RUNNING');
  logger.info('=================================================');
