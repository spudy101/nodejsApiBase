...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex({ tableName: 'user_notification_preferences', schema: SCHEMA }, ['person_id']);
    await queryInterface.addIndex({ tableName: 'user_notification_preferences', schema: SCHEMA }, ['notification_type_code']);
    await queryInterface.addIndex({ tableName: 'user_notification_preferences', schema: SCHEMA }, ['person_id', 'notification_type_code'], { unique: true });
  },
