// kyc-service/src/infrastructure/database/index.js

/**
 * Database initialization for KYC Service
 * 
 * Carga todos los modelos del servicio KYC y establece sus asociaciones.
 * Usa el schema 'kyc' de PostgreSQL.
 */
...
// Metadata
db._service = 'kyc-service';
db._schema = SCHEMA_NAME;

logger.info(`🎯 Database initialized for KYC Service (schema: ${SCHEMA_NAME})`);
