 ...
 * ✅ ACTUALIZADO: Incluye correlationId en ejemplos de error
 */
    ...
    content: {
      'application/json': {
        ...
        examples: {
          ...
          validationErrorWithCorrelation: {
            summary: 'Error de validación con correlationId',
            value: {
              success: false,
              statusCode: 422,
              message: 'Error de validación',
              ...
              errors: {
                correlationId: 'req-1737575485123-a1b2c3d4',
                details: 'Datos inválidos proporcionados'
              },
              timestamp: '2024-01-17T10:30:00.000Z'
            }
          }
