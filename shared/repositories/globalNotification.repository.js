...
const { GlobalNotification, GlobalNotificationRead } = require('../models');
    ...
    return await this.findAll(
      {
        ...
        global_notification_id: { [Op.notIn]: readIdsArray.length > 0 ? readIdsArray : ['00000000-0000-0000-0000-000000000000'] }
      },
      {
        order: [['created_at', 'DESC']],
        include: [{ association: 'notification_type' }]
