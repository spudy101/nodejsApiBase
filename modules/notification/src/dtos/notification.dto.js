...
class NotificationCreatedDTO {
  constructor(result) {
    ...
    if (result.notification_id)        this.notificationId       = result.notification_id;
    if (result.global_notification_id) this.globalNotificationId = result.global_notification_id;
  }
}
